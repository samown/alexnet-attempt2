"""
AlexNet Modified 2: With LeakyReLU Activation
Replaces ReLU with LeakyReLU activation function
"""
...
class AlexNetModified2(nn.Module):
    """
    AlexNet with LeakyReLU activation
    
    Modifications:
    - ReLU replaced with LeakyReLU (negative_slope=0.01)
    - Applied to all convolutional and fully connected layers
    - Maintains dropout and original architecture
    """
    
    def __init__(self, num_classes: int = 251, dropout: float = 0.5, negative_slope: float = 0.01):
        """
        Initialize AlexNet Modified 2 (with LeakyReLU)
        ...
        """
        super(AlexNetModified2, self).__init__()
        
        self.num_classes = num_classes
        self.dropout = dropout
        self.negative_slope = negative_slope
        
        # Feature extraction (Convolutional layers with LeakyReLU)
        ...
        # Classifier (Fully Connected layers with LeakyReLU)
